...
public class OmsPromotionServiceImpl implements OmsPromotionService {
    ...
    public List<CartPromotionItem> calcCartPromotion(List<OmsCartItem> cartItemList) {
        // 1.现根据productId对CartItem进行分组， 以spu为单位进行计算优惠
    ...
    /**
     * 对没满足优惠条件的商品进行处理
     * @param cartPromotionItemList 购物车中的优惠商品列表
     * @param itemList 购物车中的全部商品列表
     * @param promotionProduct 商品的优惠信息
     */
     ...
     * 获取购物车中指定商品的总价
     * @param itemList 购物车商品列表
     * @param promotionProductList 商品的促销信息
     * @return
     */
