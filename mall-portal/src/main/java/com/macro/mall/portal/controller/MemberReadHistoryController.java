...
public class MemberReadHistoryController {
    ...
    @ApiOperation(value = "分页获取浏览记录")
    @RequestMapping(value = "/list", method = RequestMethod.GET)
    @ResponseBody
    public CommonResult<CommonPage<MemberReadHistory>> list(@RequestParam(value = "pageSize", defaultValue = "5") Integer pageSize,
                                                            @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        Page<MemberReadHistory> page = memberReadHistoryService.list(pageSize, pageNum);
