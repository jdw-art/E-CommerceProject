...
public class OmsPortalOrderServiceImpl implements OmsPortalOrderService {
    ...
    public Map<String, Object> generateOrder(OrderParam orderParam) {
        ...
        //收货人信息：姓名、电话、邮编、地址
        UmsMemberReceiveAddress address = memberReceiveAddressService.getItem(orderParam.getMemberReceiverAddressId());
    ...
    private String generateOrderSn(OmsOrder order) {
        ...
        String key = REDIS_DATABASE + ":" + REDIS_KEY_ORDER_ID + data;
    ...
    /**
     * 锁定下单商品的所有库存
     * @param cartPromotionItemList 购物车优惠券列表
     */
