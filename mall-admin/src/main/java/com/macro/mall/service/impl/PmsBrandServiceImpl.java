...
/**
 * @Author: Jacob
 * @Description: TODO 商品品牌管理Service实现类
...
public class PmsBrandServiceImpl implements PmsBrandService {
    ...
    @Override
    public List<PmsBrand> listBrand(String keyword, Integer showStatus, Integer pageSize, Integer pageNum) {
