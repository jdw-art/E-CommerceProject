...
/**
 * @Author: Jacob
 * @Description: 首页专题推荐管理Controller
 * @Date: 2024/3/4 14:49
 * @Version: 1.0
 */
@Controller
...
public class SmsHomeRecommendSubjectController {
    ...
    public CommonResult<CommonPage<SmsHomeRecommendSubject>> list(@RequestParam(value = "subjectName", required = false) String subjectName,
        ...
        List<SmsHomeRecommendSubject> recommendSubjectList = recommendSubjectService.list(subjectName, recommendStatus, pageSize, pageNum);
