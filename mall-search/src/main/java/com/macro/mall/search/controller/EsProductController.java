...
public class EsProductController {
    ...
    public CommonResult<CommonPage<EsProduct>> search(@RequestParam(required = false) String keyword,
        ...
        return CommonResult.success(CommonPage.resetPage(esProductPage));
    }
    ...
    public CommonResult<CommonPage<EsProduct>> search(@RequestParam(required = false) String keyword,
        ...
        Page<EsProduct> esProductPage = esProductService.search(keyword, brandId, productCategoryId, pageSize, pageNum, sort);
        return CommonResult.success(CommonPage.resetPage(esProductPage));
    }

    @ApiOperation(value = "根据商品id推荐相关商品")
